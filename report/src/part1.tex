\chapter{Un titre de ouf \#TasVu}
  ...
  \section{Principes généraux}
    ...
    \subsubsection{Les caches}
      ...
      %% TODO: trouver une image simple avec trois niveaux de cache
      \myfig{0.4}{img/caches.png}{Schéma des niveaux caches d'un processeur}{f:caches}
    ...
    \myfig{0.5}{img/mmu2.png}{Schéma des communications entre le processeur et la MMU}{f:mmu2}
    ...
    \myfig{0.25}{img/tdp.png}{TODO}{f:tdp}
    ...
    \myfig{0.6}{img/cache_mmu_global2.jpg}{TODO}{f:memory}
  ...
  \section{L'architecture NUMA}
    ...
    \textit{NB: Dans cette partie nous détaillerons uniquement l'architecture de
  ...
  \subsection{Les noeuds}
    ...
    \myfig{0.3}{img/mcm.png}{Illustration d'un MultiChip module pour une machine}{f:mcm}
  ...
  \subsection{La communication entre les noeuds}
    ...
    \myfig{0.5}{img/topo.png}{Schéma de la topologie du \textit{Magny Cour}}{f:topo}
    %% TODO: faut caler Magny Cour quelque part dans l'intro}
  ...
  \subsection{Les contrôleurs d'entrées/sorties}
    ...
    %% TODO: lire (trouver ?) la doc sur les I/O et faire un petit paragraphe
    %% dessus. Je sais pas trop quoi dire
